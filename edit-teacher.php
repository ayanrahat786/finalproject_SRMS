...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $msg = "Teachers info updated successfully";
    }
    ...
    <head>
        ...
        <title>SMS Admin| Edit Teachers < </title>
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Teachers Admission</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Teachers Admission</li>
                                    </ul>
                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="fullanme" class="form-control"
                                                                    id="fullanme"
                                                                    value="<?php echo htmlentities($result->teacherName) ?>"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="email" name="emailid" class="form-control" id="email"
                                                                    value="<?php echo htmlentities($result->teacherEmail) ?>"
                                                                    required="required" autocomplete="off">
                                                            </div>
                                                        </div>
