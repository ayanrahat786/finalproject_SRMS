                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Student's Name
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Father's Name
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                <label for="default" class="col-sm-2 control-label">Mother's Name
                                                </label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="radio" name="gender" value="Male" required="required"
                                                        ...
                                                        type="radio" name="gender" value="Other" required="required">
                                                    &nbsp;Other
                                                </div>
                                            </div>
