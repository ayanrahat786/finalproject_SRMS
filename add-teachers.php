...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $classid = $_POST['class'];
        $status = 1;
        $sql = "INSERT INTO  tblteachers(teacherName,password,teacherEmail,gender,ClassId) VALUES(:studentname,:password,:studentemail,:gender,:classid)";
        ...
        if ($lastInsertId) {
            $msg = "Teachers info added successfully";
        } else {
