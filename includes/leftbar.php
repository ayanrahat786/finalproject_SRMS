        ...
        <?php } ?>
            ...
            <li class="has-children">
                <a href="#"><i class="fa fa-users"></i> <span>Teachers</span> <i
                        class="fa fa-angle-right arrow"></i></a>
                <ul class="child-nav">
                    <li><a href="add-teachers.php"><i class="fa fa-bars"></i> <span>Add Teacher</span></a></li>
                    <li><a href="manage-teachers.php"><i class="fa fa fa-server"></i> <span>Manage Teacher</span></a>
                    </li>
