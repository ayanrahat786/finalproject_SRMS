...
<html lang="en">
  ...
  <img src="images/logo.jpg" class="pt-4" width="100%">
    ...
    <?php
                                                ...
                                                $qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblstudents.DOB,tblstudents.FatherName,tblstudents.Address,tblstudents.MotherName,tblstudents.Contact,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
    ...
    <table class="table table-bordered" >
      <tr>
        ...
        <td colspan="4"><?php echo htmlentities($row->DOB); ?> </td>
      </tr>
      <tr>
        <th>Student's Name :</th>
        <td colspan="6"><?php echo htmlentities($row->StudentName); ?></td>
        <td colspan="2" rowspan="2">Address:</td>
        <td colspan="4" rowspan="2"><?php echo htmlentities($row->Address); ?></td>
      </tr>
     
      <tr>
        <th>Father's Name :</th>
        <td colspan="6" ><?php echo htmlentities($row->FatherName); ?></td>
      </tr>
      <tr>
        <th>Mother's Name :</th>
        <td colspan="6" ><?php echo htmlentities($row->MotherName); ?></td>
        <td colspan="2">Contact No:</td>
        <td colspan="4"><?php echo htmlentities($row->Contact); ?></td>
      </tr>
      <?php }?>
      <tr>
